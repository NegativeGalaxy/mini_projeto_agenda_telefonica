...
def perguntar_nome():
    while True:
        ...
        if nome == "" or (len(nome) <= 20 and all(c.isalpha() or c == " " for c in nome)):
            return nome
        else:
...
def perguntar_sobrenome():
    while True:
        ...
        # Remove espaços extras no início/fim e verifica se os caracteres são letras ou espaços
        if sobrenome == "" or (len(sobrenome) <= 20 and all(c.isalpha() or c == " " for c in sobrenome)):
            return sobrenome
        else:
            print("O valor não atende a especificação do campo.")
...
def perguntar_celular():
    while True:
        ...
        if celular == "" or (celular.isdigit() and len(celular) <= 15):
            return celular
        else:
            print("O valor não atende a especificação do campo.")
